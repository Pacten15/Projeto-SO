...
HEADERS  := $(wildcard */*.h)
OBJECTS  := $(SOURCES:.c=.o)
TARGET_EXECS := tests/test1 tests/thread_test_copy_external tests/thread_test_read tests/thread_test_write  tests/thread_close   tests/copy_to_external_simple tests/copy_to_external_errors tests/write_10_blocks_spill tests/write_10_blocks_simple tests/write_more_than_10_blocks_simple 
...
# Warnings
CFLAGS += -fdiagnostics-color=always -Wall -Werror -Wextra -Wcast-align -Wconversion -Wfloat-equal -Wformat=2 -Wnull-dereference -Wshadow -Wsign-conversion -Wswitch-default -Wswitch-enum -Wundef -Wunreachable-code -Wunused -fPIE -ltsan -pthread
...
tests/thread_test_read: tests/thread_test_read.c fs/operations.o fs/state.o
tests/thread_test_write: tests/thread_test_write.c fs/operations.o fs/state.o
tests/thread_test_copy_external: tests/thread_test_copy_external.c fs/operations.o fs/state.o
tests/thread_close: tests/thread_close.c fs/operations.o fs/state.o
